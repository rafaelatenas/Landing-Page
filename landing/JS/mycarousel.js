class Carousel {
    ...
    _setInitialSettings(settings) {
        ...
        if (this._buttonsHide) {
            let buttons = this._container.getElementById(
                "arrow-right"
            );
            for (let i = 0; i < buttons.length; i++) {
                buttons[i].style.display = "none";
            }
            buttons = this._container.getElementById("arrow-right");
            for (let i = 0; i < buttons.length; i++) {
                buttons[i].style.display = "none";
            }
        }
        ...
        if (this._disableForSingle && this._totalItems === 1) {
            ...
            buttons = this._container.getElementById("arrow-left");
            for (let i = 0; i < buttons.length; i++) {
                buttons[i].style.display = "none";
            }
        }
        ...
        if (this._fitToChildren) {
            this._container.style.maxWidth = this._container.clientWidth + "%";
